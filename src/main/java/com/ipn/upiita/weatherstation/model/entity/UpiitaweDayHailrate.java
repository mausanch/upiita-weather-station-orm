...
@Data
@Entity(name="upiitawe_day_hailrate")
public class UpiitaweDayHailrate implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayHailrate.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayHailrate and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayHailrate)) {
            return false;
        }
        UpiitaweDayHailrate that = (UpiitaweDayHailrate) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayHailrate.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayHailrate)) return false;
        return this.equalKeys(other) && ((UpiitaweDayHailrate)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayHailrate |");
