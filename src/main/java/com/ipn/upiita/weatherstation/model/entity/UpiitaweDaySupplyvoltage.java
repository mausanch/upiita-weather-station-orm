...
@Data
@Entity(name="upiitawe_day_supplyvoltage")
public class UpiitaweDaySupplyvoltage implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDaySupplyvoltage() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDaySupplyvoltage.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDaySupplyvoltage and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDaySupplyvoltage)) {
            return false;
        }
        UpiitaweDaySupplyvoltage that = (UpiitaweDaySupplyvoltage) other;
    ...
    /**
     * Compares this instance with another UpiitaweDaySupplyvoltage.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDaySupplyvoltage)) return false;
        return this.equalKeys(other) && ((UpiitaweDaySupplyvoltage)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDaySupplyvoltage |");
