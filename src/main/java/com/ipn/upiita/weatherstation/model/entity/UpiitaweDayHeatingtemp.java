...
@Data
@Entity(name="upiitawe_day_heatingtemp")
public class UpiitaweDayHeatingtemp implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayHeatingtemp.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayHeatingtemp and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayHeatingtemp)) {
            return false;
        }
        UpiitaweDayHeatingtemp that = (UpiitaweDayHeatingtemp) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayHeatingtemp.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayHeatingtemp)) return false;
        return this.equalKeys(other) && ((UpiitaweDayHeatingtemp)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayHeatingtemp |");
