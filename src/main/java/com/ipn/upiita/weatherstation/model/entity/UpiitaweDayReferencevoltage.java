...
@Data
@Entity(name="upiitawe_day_referencevoltage")
public class UpiitaweDayReferencevoltage implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDayReferencevoltage() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayReferencevoltage.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayReferencevoltage and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayReferencevoltage)) {
            return false;
        }
        UpiitaweDayReferencevoltage that = (UpiitaweDayReferencevoltage) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayReferencevoltage.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayReferencevoltage)) return false;
        return this.equalKeys(other) && ((UpiitaweDayReferencevoltage)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayReferencevoltage |");
