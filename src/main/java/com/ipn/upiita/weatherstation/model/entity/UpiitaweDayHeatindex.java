...
@Data
@Entity(name="upiitawe_day_heatindex")
public class UpiitaweDayHeatindex implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayHeatindex.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayHeatindex and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayHeatindex)) {
            return false;
        }
        UpiitaweDayHeatindex that = (UpiitaweDayHeatindex) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayHeatindex.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayHeatindex)) return false;
        return this.equalKeys(other) && ((UpiitaweDayHeatindex)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayHeatindex |");
