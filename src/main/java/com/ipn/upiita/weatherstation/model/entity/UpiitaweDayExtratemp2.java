...
@Data
@Entity(name="upiitawe_day_extratemp2")
public class UpiitaweDayExtratemp2 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayExtratemp2.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayExtratemp2 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayExtratemp2)) {
            return false;
        }
        UpiitaweDayExtratemp2 that = (UpiitaweDayExtratemp2) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayExtratemp2.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayExtratemp2)) return false;
        return this.equalKeys(other) && ((UpiitaweDayExtratemp2)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayExtratemp2 |");
