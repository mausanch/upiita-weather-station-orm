...
@Data
@Entity(name="upiitawe_day_hail")
public class UpiitaweDayHail implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayHail.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayHail and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayHail)) {
            return false;
        }
        UpiitaweDayHail that = (UpiitaweDayHail) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayHail.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayHail)) return false;
        return this.equalKeys(other) && ((UpiitaweDayHail)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayHail |");
