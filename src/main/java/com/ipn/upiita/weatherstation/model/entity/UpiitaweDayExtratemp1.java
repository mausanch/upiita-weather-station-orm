...
@Data
@Entity(name="upiitawe_day_extratemp1")
public class UpiitaweDayExtratemp1 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayExtratemp1.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayExtratemp1 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayExtratemp1)) {
            return false;
        }
        UpiitaweDayExtratemp1 that = (UpiitaweDayExtratemp1) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayExtratemp1.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayExtratemp1)) return false;
        return this.equalKeys(other) && ((UpiitaweDayExtratemp1)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayExtratemp1 |");
