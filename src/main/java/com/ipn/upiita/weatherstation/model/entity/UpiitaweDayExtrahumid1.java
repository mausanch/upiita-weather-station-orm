...
@Data
@Entity(name="upiitawe_day_extrahumid1")
public class UpiitaweDayExtrahumid1 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayExtrahumid1.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayExtrahumid1 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayExtrahumid1)) {
            return false;
        }
        UpiitaweDayExtrahumid1 that = (UpiitaweDayExtrahumid1) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayExtrahumid1.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayExtrahumid1)) return false;
        return this.equalKeys(other) && ((UpiitaweDayExtrahumid1)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayExtrahumid1 |");
