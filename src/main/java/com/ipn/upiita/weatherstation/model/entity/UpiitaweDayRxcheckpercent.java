...
@Data
@Entity(name="upiitawe_day_rxcheckpercent")
public class UpiitaweDayRxcheckpercent implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDayRxcheckpercent() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayRxcheckpercent.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayRxcheckpercent and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayRxcheckpercent)) {
            return false;
        }
        UpiitaweDayRxcheckpercent that = (UpiitaweDayRxcheckpercent) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayRxcheckpercent.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayRxcheckpercent)) return false;
        return this.equalKeys(other) && ((UpiitaweDayRxcheckpercent)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayRxcheckpercent |");
