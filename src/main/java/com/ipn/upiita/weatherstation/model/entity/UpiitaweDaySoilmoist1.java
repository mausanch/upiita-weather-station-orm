...
@Data
@Entity(name="upiitawe_day_soilmoist1")
public class UpiitaweDaySoilmoist1 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDaySoilmoist1.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDaySoilmoist1 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDaySoilmoist1)) {
            return false;
        }
        UpiitaweDaySoilmoist1 that = (UpiitaweDaySoilmoist1) other;
    ...
    /**
     * Compares this instance with another UpiitaweDaySoilmoist1.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDaySoilmoist1)) return false;
        return this.equalKeys(other) && ((UpiitaweDaySoilmoist1)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDaySoilmoist1 |");
