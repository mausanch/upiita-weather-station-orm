...
@Data
@Entity(name="upiitawe_day_altimeter")
public class UpiitaweDayAltimeter implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayAltimeter.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayAltimeter and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayAltimeter)) {
            return false;
        }
        UpiitaweDayAltimeter that = (UpiitaweDayAltimeter) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayAltimeter.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayAltimeter)) return false;
        return this.equalKeys(other) && ((UpiitaweDayAltimeter)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayAltimeter |");
