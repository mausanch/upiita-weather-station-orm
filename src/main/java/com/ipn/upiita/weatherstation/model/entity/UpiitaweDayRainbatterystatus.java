...
@Data
@Entity(name="upiitawe_day_rainbatterystatus")
public class UpiitaweDayRainbatterystatus implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDayRainbatterystatus() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayRainbatterystatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayRainbatterystatus and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayRainbatterystatus)) {
            return false;
        }
        UpiitaweDayRainbatterystatus that = (UpiitaweDayRainbatterystatus) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayRainbatterystatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayRainbatterystatus)) return false;
        return this.equalKeys(other) && ((UpiitaweDayRainbatterystatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayRainbatterystatus |");
