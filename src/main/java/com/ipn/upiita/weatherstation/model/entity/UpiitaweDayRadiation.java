...
@Data
@Entity(name="upiitawe_day_radiation")
public class UpiitaweDayRadiation implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayRadiation.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayRadiation and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayRadiation)) {
            return false;
        }
        UpiitaweDayRadiation that = (UpiitaweDayRadiation) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayRadiation.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayRadiation)) return false;
        return this.equalKeys(other) && ((UpiitaweDayRadiation)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayRadiation |");
