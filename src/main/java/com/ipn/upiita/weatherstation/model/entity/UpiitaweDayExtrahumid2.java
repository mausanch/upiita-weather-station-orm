...
@Data
@Entity(name="upiitawe_day_extrahumid2")
public class UpiitaweDayExtrahumid2 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayExtrahumid2.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayExtrahumid2 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayExtrahumid2)) {
            return false;
        }
        UpiitaweDayExtrahumid2 that = (UpiitaweDayExtrahumid2) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayExtrahumid2.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayExtrahumid2)) return false;
        return this.equalKeys(other) && ((UpiitaweDayExtrahumid2)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayExtrahumid2 |");
