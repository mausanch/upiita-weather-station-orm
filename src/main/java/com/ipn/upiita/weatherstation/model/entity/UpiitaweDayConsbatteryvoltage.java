...
@Data
@Entity(name="upiitawe_day_consbatteryvoltage")
public class UpiitaweDayConsbatteryvoltage implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDayConsbatteryvoltage() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayConsbatteryvoltage.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayConsbatteryvoltage and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayConsbatteryvoltage)) {
            return false;
        }
        UpiitaweDayConsbatteryvoltage that = (UpiitaweDayConsbatteryvoltage) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayConsbatteryvoltage.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayConsbatteryvoltage)) return false;
        return this.equalKeys(other) && ((UpiitaweDayConsbatteryvoltage)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayConsbatteryvoltage |");
