...
@Data
@Entity(name="upiitawe_day_heatingvoltage")
public class UpiitaweDayHeatingvoltage implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDayHeatingvoltage() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayHeatingvoltage.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayHeatingvoltage and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayHeatingvoltage)) {
            return false;
        }
        UpiitaweDayHeatingvoltage that = (UpiitaweDayHeatingvoltage) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayHeatingvoltage.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayHeatingvoltage)) return false;
        return this.equalKeys(other) && ((UpiitaweDayHeatingvoltage)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayHeatingvoltage |");
