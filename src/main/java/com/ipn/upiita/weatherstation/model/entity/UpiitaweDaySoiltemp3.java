...
@Data
@Entity(name="upiitawe_day_soiltemp3")
public class UpiitaweDaySoiltemp3 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDaySoiltemp3.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDaySoiltemp3 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDaySoiltemp3)) {
            return false;
        }
        UpiitaweDaySoiltemp3 that = (UpiitaweDaySoiltemp3) other;
    ...
    /**
     * Compares this instance with another UpiitaweDaySoiltemp3.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDaySoiltemp3)) return false;
        return this.equalKeys(other) && ((UpiitaweDaySoiltemp3)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDaySoiltemp3 |");
