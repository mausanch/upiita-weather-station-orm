...
@Data
@Entity(name="upiitawe_day_soiltemp4")
public class UpiitaweDaySoiltemp4 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDaySoiltemp4.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDaySoiltemp4 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDaySoiltemp4)) {
            return false;
        }
        UpiitaweDaySoiltemp4 that = (UpiitaweDaySoiltemp4) other;
    ...
    /**
     * Compares this instance with another UpiitaweDaySoiltemp4.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDaySoiltemp4)) return false;
        return this.equalKeys(other) && ((UpiitaweDaySoiltemp4)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDaySoiltemp4 |");
