...
@Data
@Entity(name="upiitawe_day_outhumidity")
public class UpiitaweDayOuthumidity implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayOuthumidity.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayOuthumidity and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayOuthumidity)) {
            return false;
        }
        UpiitaweDayOuthumidity that = (UpiitaweDayOuthumidity) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayOuthumidity.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayOuthumidity)) return false;
        return this.equalKeys(other) && ((UpiitaweDayOuthumidity)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayOuthumidity |");
