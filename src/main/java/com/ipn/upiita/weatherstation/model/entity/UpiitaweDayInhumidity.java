...
@Data
@Entity(name="upiitawe_day_inhumidity")
public class UpiitaweDayInhumidity implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayInhumidity.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayInhumidity and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayInhumidity)) {
            return false;
        }
        UpiitaweDayInhumidity that = (UpiitaweDayInhumidity) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayInhumidity.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayInhumidity)) return false;
        return this.equalKeys(other) && ((UpiitaweDayInhumidity)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayInhumidity |");
