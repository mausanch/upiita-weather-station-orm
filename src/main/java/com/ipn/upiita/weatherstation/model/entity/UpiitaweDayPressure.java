...
@Data
@Entity(name="upiitawe_day_pressure")
public class UpiitaweDayPressure implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayPressure.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayPressure and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayPressure)) {
            return false;
        }
        UpiitaweDayPressure that = (UpiitaweDayPressure) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayPressure.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayPressure)) return false;
        return this.equalKeys(other) && ((UpiitaweDayPressure)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayPressure |");
