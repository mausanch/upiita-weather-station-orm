...
public class UpiitaweDayWindspeed implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayWindspeed.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayWindspeed and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayWindspeed)) {
            return false;
        }
        UpiitaweDayWindspeed that = (UpiitaweDayWindspeed) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayWindspeed.
     *
     * @param other The object to compare to
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayWindspeed |");
