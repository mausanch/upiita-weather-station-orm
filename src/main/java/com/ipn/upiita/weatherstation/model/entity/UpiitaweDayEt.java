...
@Data
@Entity(name="upiitawe_day_et")
public class UpiitaweDayEt implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayEt.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayEt and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayEt)) {
            return false;
        }
        UpiitaweDayEt that = (UpiitaweDayEt) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayEt.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayEt)) return false;
        return this.equalKeys(other) && ((UpiitaweDayEt)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayEt |");
