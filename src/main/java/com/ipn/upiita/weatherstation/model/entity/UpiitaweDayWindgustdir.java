...
@Data
@Entity(name="upiitawe_day_windgustdir")
public class UpiitaweDayWindgustdir implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayWindgustdir.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayWindgustdir and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayWindgustdir)) {
            return false;
        }
        UpiitaweDayWindgustdir that = (UpiitaweDayWindgustdir) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayWindgustdir.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayWindgustdir)) return false;
        return this.equalKeys(other) && ((UpiitaweDayWindgustdir)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayWindgustdir |");
