...
@Data
@Entity(name="upiitawe_day_rain")
public class UpiitaweDayRain implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayRain.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayRain and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayRain)) {
            return false;
        }
        UpiitaweDayRain that = (UpiitaweDayRain) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayRain.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayRain)) return false;
        return this.equalKeys(other) && ((UpiitaweDayRain)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayRain |");
