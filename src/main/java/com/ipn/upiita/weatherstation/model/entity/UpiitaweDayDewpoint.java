...
@Data
@Entity(name="upiitawe_day_dewpoInteger")
public class UpiitaweDayDewpoint implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayDewpoInteger.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayDewpoInteger and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayDewpoint)) {
            return false;
        }
        UpiitaweDayDewpoint that = (UpiitaweDayDewpoint) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayDewpoInteger.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayDewpoint)) return false;
        return this.equalKeys(other) && ((UpiitaweDayDewpoint)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayDewpoInteger |");
