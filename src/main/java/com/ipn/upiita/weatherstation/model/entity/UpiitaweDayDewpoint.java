...
@Data
@Entity(name="upiitawe_day_dewpoint")
public class UpiitaweDayDewpoint implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayDewpoint.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayDewpoint and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another UpiitaweDayDewpoint.
     *
     * @param other The object to compare to
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayDewpoint |");
