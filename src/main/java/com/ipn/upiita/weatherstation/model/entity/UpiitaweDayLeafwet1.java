...
@Data
@Entity(name="upiitawe_day_leafwet1")
public class UpiitaweDayLeafwet1 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayLeafwet1.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayLeafwet1 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayLeafwet1)) {
            return false;
        }
        UpiitaweDayLeafwet1 that = (UpiitaweDayLeafwet1) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayLeafwet1.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayLeafwet1)) return false;
        return this.equalKeys(other) && ((UpiitaweDayLeafwet1)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayLeafwet1 |");
