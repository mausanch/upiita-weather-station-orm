...
@Data
@Entity(name="upiitawe_day_Integeremp")
public class UpiitaweDayIntemp implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayIntemp.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayIntemp and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayIntemp)) {
            return false;
        }
        UpiitaweDayIntemp that = (UpiitaweDayIntemp) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayIntemp.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayIntemp)) return false;
        return this.equalKeys(other) && ((UpiitaweDayIntemp)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayIntemp |");
