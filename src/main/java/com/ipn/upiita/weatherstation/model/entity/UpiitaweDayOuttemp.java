...
@Data
@Entity(name="upiitawe_day_outtemp")
public class UpiitaweDayOuttemp implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayOuttemp.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayOuttemp and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayOuttemp)) {
            return false;
        }
        UpiitaweDayOuttemp that = (UpiitaweDayOuttemp) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayOuttemp.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayOuttemp)) return false;
        return this.equalKeys(other) && ((UpiitaweDayOuttemp)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayOuttemp |");
