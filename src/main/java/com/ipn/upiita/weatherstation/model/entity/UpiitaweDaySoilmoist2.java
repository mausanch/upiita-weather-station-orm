...
@Data
@Entity(name="upiitawe_day_soilmoist2")
public class UpiitaweDaySoilmoist2 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDaySoilmoist2.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDaySoilmoist2 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDaySoilmoist2)) {
            return false;
        }
        UpiitaweDaySoilmoist2 that = (UpiitaweDaySoilmoist2) other;
    ...
    /**
     * Compares this instance with another UpiitaweDaySoilmoist2.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDaySoilmoist2)) return false;
        return this.equalKeys(other) && ((UpiitaweDaySoilmoist2)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDaySoilmoist2 |");
