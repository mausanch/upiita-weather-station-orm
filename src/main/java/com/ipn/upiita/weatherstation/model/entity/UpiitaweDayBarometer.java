...
@Data
@Entity(name="upiitawe_day_barometer")
public class UpiitaweDayBarometer implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayBarometer.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayBarometer and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayBarometer)) {
            return false;
        }
        UpiitaweDayBarometer that = (UpiitaweDayBarometer) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayBarometer.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayBarometer)) return false;
        return this.equalKeys(other) && ((UpiitaweDayBarometer)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayBarometer |");
