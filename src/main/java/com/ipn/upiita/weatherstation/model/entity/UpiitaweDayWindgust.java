...
@Data
@Entity(name="upiitawe_day_windgust")
public class UpiitaweDayWindgust implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayWindgust.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayWindgust and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayWindgust)) {
            return false;
        }
        UpiitaweDayWindgust that = (UpiitaweDayWindgust) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayWindgust.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayWindgust)) return false;
        return this.equalKeys(other) && ((UpiitaweDayWindgust)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayWindgust |");
