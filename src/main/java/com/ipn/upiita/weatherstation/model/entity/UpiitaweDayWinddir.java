...
@Data
@Entity(name="upiitawe_day_winddir")
public class UpiitaweDayWinddir implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayWinddir.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayWinddir and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayWinddir)) {
            return false;
        }
        UpiitaweDayWinddir that = (UpiitaweDayWinddir) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayWinddir.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayWinddir)) return false;
        return this.equalKeys(other) && ((UpiitaweDayWinddir)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayWinddir |");
