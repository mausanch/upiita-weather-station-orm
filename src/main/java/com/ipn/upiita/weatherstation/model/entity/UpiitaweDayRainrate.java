...
@Data
@Entity(name="upiitawe_day_rainrate")
public class UpiitaweDayRainrate implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayRainrate.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayRainrate and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayRainrate)) {
            return false;
        }
        UpiitaweDayRainrate that = (UpiitaweDayRainrate) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayRainrate.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayRainrate)) return false;
        return this.equalKeys(other) && ((UpiitaweDayRainrate)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayRainrate |");
