...
@Data
@Entity(name="upiitawe_day_soiltemp2")
public class UpiitaweDaySoiltemp2 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDaySoiltemp2.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDaySoiltemp2 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDaySoiltemp2)) {
            return false;
        }
        UpiitaweDaySoiltemp2 that = (UpiitaweDaySoiltemp2) other;
    ...
    /**
     * Compares this instance with another UpiitaweDaySoiltemp2.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDaySoiltemp2)) return false;
        return this.equalKeys(other) && ((UpiitaweDaySoiltemp2)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDaySoiltemp2 |");
