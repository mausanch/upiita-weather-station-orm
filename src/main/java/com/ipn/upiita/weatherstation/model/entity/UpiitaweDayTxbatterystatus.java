...
@Data
@Entity(name="upiitawe_day_txbatterystatus")
public class UpiitaweDayTxbatterystatus implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDayTxbatterystatus() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayTxbatterystatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayTxbatterystatus and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayTxbatterystatus)) {
            return false;
        }
        UpiitaweDayTxbatterystatus that = (UpiitaweDayTxbatterystatus) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayTxbatterystatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayTxbatterystatus)) return false;
        return this.equalKeys(other) && ((UpiitaweDayTxbatterystatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayTxbatterystatus |");
