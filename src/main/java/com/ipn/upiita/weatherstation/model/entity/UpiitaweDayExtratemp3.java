...
@Data
@Entity(name="upiitawe_day_extratemp3")
public class UpiitaweDayExtratemp3 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayExtratemp3.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayExtratemp3 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayExtratemp3)) {
            return false;
        }
        UpiitaweDayExtratemp3 that = (UpiitaweDayExtratemp3) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayExtratemp3.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayExtratemp3)) return false;
        return this.equalKeys(other) && ((UpiitaweDayExtratemp3)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayExtratemp3 |");
