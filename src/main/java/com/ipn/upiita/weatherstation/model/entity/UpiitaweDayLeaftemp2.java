...
@Data
@Entity(name="upiitawe_day_leaftemp2")
public class UpiitaweDayLeaftemp2 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayLeaftemp2.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayLeaftemp2 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayLeaftemp2)) {
            return false;
        }
        UpiitaweDayLeaftemp2 that = (UpiitaweDayLeaftemp2) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayLeaftemp2.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayLeaftemp2)) return false;
        return this.equalKeys(other) && ((UpiitaweDayLeaftemp2)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayLeaftemp2 |");
