...
@Data
@Entity(name="upiitawe_day_leafwet2")
public class UpiitaweDayLeafwet2 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayLeafwet2.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayLeafwet2 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayLeafwet2)) {
            return false;
        }
        UpiitaweDayLeafwet2 that = (UpiitaweDayLeafwet2) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayLeafwet2.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayLeafwet2)) return false;
        return this.equalKeys(other) && ((UpiitaweDayLeafwet2)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayLeafwet2 |");
