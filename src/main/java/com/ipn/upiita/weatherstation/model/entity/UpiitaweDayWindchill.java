...
@Data
@Entity(name="upiitawe_day_windchill")
public class UpiitaweDayWindchill implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayWindchill.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayWindchill and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayWindchill)) {
            return false;
        }
        UpiitaweDayWindchill that = (UpiitaweDayWindchill) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayWindchill.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayWindchill)) return false;
        return this.equalKeys(other) && ((UpiitaweDayWindchill)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayWindchill |");
