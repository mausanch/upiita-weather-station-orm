...
@Data
@Entity(name="upiitawe_day_soilmoist4")
public class UpiitaweDaySoilmoist4 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDaySoilmoist4.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDaySoilmoist4 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDaySoilmoist4)) {
            return false;
        }
        UpiitaweDaySoilmoist4 that = (UpiitaweDaySoilmoist4) other;
    ...
    /**
     * Compares this instance with another UpiitaweDaySoilmoist4.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDaySoilmoist4)) return false;
        return this.equalKeys(other) && ((UpiitaweDaySoilmoist4)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDaySoilmoist4 |");
