...
@Data
@Entity(name="upiitawe_day_soiltemp1")
public class UpiitaweDaySoiltemp1 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDaySoiltemp1.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDaySoiltemp1 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDaySoiltemp1)) {
            return false;
        }
        UpiitaweDaySoiltemp1 that = (UpiitaweDaySoiltemp1) other;
    ...
    /**
     * Compares this instance with another UpiitaweDaySoiltemp1.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDaySoiltemp1)) return false;
        return this.equalKeys(other) && ((UpiitaweDaySoiltemp1)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDaySoiltemp1 |");
