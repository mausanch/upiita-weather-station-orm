...
@Data
@Entity(name="upiitawe_day_uv")
public class UpiitaweDayUv implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayUv.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayUv and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayUv)) {
            return false;
        }
        UpiitaweDayUv that = (UpiitaweDayUv) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayUv.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayUv)) return false;
        return this.equalKeys(other) && ((UpiitaweDayUv)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayUv |");
