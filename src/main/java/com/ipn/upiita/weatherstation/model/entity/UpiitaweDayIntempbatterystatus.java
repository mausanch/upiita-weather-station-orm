...
@Data
@Entity(name="upiitawe_day_Integerempbatterystatus")
public class UpiitaweDayIntempbatterystatus implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDayIntempbatterystatus() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayIntempbatterystatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayIntempbatterystatus and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayIntempbatterystatus)) {
            return false;
        }
        UpiitaweDayIntempbatterystatus that = (UpiitaweDayIntempbatterystatus) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayIntempbatterystatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayIntempbatterystatus)) return false;
        return this.equalKeys(other) && ((UpiitaweDayIntempbatterystatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayIntempbatterystatus |");
