...
@Data
@Entity(name="upiitawe_day_outtempbatterystatus")
public class UpiitaweDayOuttempbatterystatus implements Serializable {
    ...
    /** Default constructor. */
    public UpiitaweDayOuttempbatterystatus() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayOuttempbatterystatus.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayOuttempbatterystatus and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayOuttempbatterystatus)) {
            return false;
        }
        UpiitaweDayOuttempbatterystatus that = (UpiitaweDayOuttempbatterystatus) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayOuttempbatterystatus.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayOuttempbatterystatus)) return false;
        return this.equalKeys(other) && ((UpiitaweDayOuttempbatterystatus)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayOuttempbatterystatus |");
