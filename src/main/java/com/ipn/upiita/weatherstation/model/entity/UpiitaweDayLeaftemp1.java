...
@Data
@Entity(name="upiitawe_day_leaftemp1")
public class UpiitaweDayLeaftemp1 implements Serializable {
    ...
    /**
     * Compares the key for this instance with another UpiitaweDayLeaftemp1.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class UpiitaweDayLeaftemp1 and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof UpiitaweDayLeaftemp1)) {
            return false;
        }
        UpiitaweDayLeaftemp1 that = (UpiitaweDayLeaftemp1) other;
    ...
    /**
     * Compares this instance with another UpiitaweDayLeaftemp1.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof UpiitaweDayLeaftemp1)) return false;
        return this.equalKeys(other) && ((UpiitaweDayLeaftemp1)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[UpiitaweDayLeaftemp1 |");
